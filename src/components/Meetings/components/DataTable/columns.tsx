...
const statusColorMap = {
  ...
  processing: "bg-purple-500/20 text-purple-800",
...
export const columns: ColumnDef<Meeting>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const Icon =
        statusIconMap[
          row.original.status.toLowerCase() as keyof typeof statusIconMap
        ];
      ...
      return (
        <Badge
          ...
          className={cn(
            ...
            statusColorMap[
              row.original.status.toLowerCase() as keyof typeof statusColorMap
            ]
          )}
        >
          <Icon
